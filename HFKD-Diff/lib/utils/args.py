...
config_parser.add_argument('-c', '--config', default='/home/user1/diffusion-kd/kd-diffusion-ofa-v1/experiments/OFA/mixerb-16--resnet18/checkpoint-314.pth.tar', type=str,
...
parser = argparse.ArgumentParser(description='ImageNet Training')
    ...
    # dist_beta: 1
    # dist_gamma: 1
parser.add_argument('--assist_kd',  default="kd", type=str, 
                    help='assist with our kd')
#MLKD
parser.add_argument('--mlkd_ce', type=int,default=0.1,
                    help=' MLKD CE Loss weight')
parser.add_argument('--mlkd_kd',  type=int, default=9,
                    help=' MLKD kd Loss weight')
#DKD
parser.add_argument('--dkd_alpha', type=int,default=1,
                    help=' DKD Loss weight')
parser.add_argument('--dkd_beta', type=int,default=8,
                    help=' DKD  Loss weight')
#DIST
parser.add_argument('--dist_beta', type=int,default=1,
                    help=' dist Loss weight')
parser.add_argument('--dist_gamma', type=int,default=1,
                    help=' dist  Loss weight')


parser.add_argument('--student_is_cnn', action='store_true', default=True,
                    help='The student is cnn or other')
...
parser.add_argument('--num_class', type=int, default=100,
                    help='model classes numbers (default: 100)')
...
parser.add_argument('--input-shape', type=float, nargs='+', default=[3, 224, 224],
                    help='Random resize scale (default: 0.08 1.0)')
...
parser.add_argument('--data-path', default='/home/user1/diffusion-kd/classification/data/cifar100', type=str,
...
parser.add_argument('--schedule', default=[60, 120, 150], type=int, nargs='+',help='decay epochs,use ciafar100 ')
...
parser.add_argument('--eps', type=float, default=2,
                    help='adaptive enhence classification information')

parser.add_argument('--cross_head', type=float, default=8,
                    help='adaptive enhence classification information')

parser.add_argument('--kd', type=str, default='diffkd',
...
parser.add_argument('--student-pretrained', action='store_false', default=True)
